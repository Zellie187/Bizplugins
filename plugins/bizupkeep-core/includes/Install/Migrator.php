...
/**
 * Applies the BizUpKeep Core database schema using WordPress's
...
{
    private const VERSION_OPTION = 'bizupkeep_core_db_version';
    ...
    /**
     * Create or update every BizUpKeep Core table to match the current
     * schema.
     */
