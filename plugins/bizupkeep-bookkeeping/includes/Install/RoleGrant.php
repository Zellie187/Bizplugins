...
/**
 * Grants BizUpKeep Bookkeeping's capabilities to roles, as configured in
 ...
 *
 * Custom capability strings (e.g. "bookkeeping.manage") are not native
...
{
    /**
     * Grant every configured BizUpKeep Bookkeeping capability to its
     * configured roles, where those roles exist.
     */
    public function install(): void
    {
        /** @var array<string,array<int,string>> $grants */
        $grants = require BIZUPKEEP_BOOKKEEPING_CONFIG_PATH . 'permissions.php';
