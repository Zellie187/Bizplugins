 ...
 * bizupkeep-workflow's tests/Mocks/InMemoryDatabase.php (itself
 * mirroring BizHub\Tests\Mocks\InMemoryDatabase), so repositories in
 * this plugin are exercised against the same semantics as every other
