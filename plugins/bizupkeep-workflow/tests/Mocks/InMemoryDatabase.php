...
namespace BizHub\Workflow\Tests\Mocks;
...
/**
 * In-memory DatabaseInterface implementation for tests. Mirrors
 * BizHub\Tests\Mocks\InMemoryDatabase exactly, so WorkflowRepository
 * is exercised against the same semantics its BizHub counterparts
 * (e.g. CompanyRepository) are tested against.
 *
