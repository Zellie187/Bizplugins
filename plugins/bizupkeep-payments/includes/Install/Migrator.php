...
/**
 * Applies the BizUpKeep Payments database schema using WordPress's
...
{
    private const VERSION_OPTION = 'bizupkeep_payments_db_version';
    ...
    /**
     * Create or update every BizUpKeep Payments table to match the
     * current schema.
     */
